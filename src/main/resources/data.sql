...
insert into challenge_card (id, assign_score, description, difficulty, final_goal, title, experience) values (33L, 30, 'desc', 2, '사진 인증', 'tid3tle', 1);
insert into challenge_card (id, assign_score, description, difficulty, final_goal, title, experience) values (34L, 30, 'desc', 2, '사진 인증', 'titleb', 1);
insert into challenge_card (id, assign_score, description, difficulty, final_goal, title, experience) values (35L, 30, 'desc', 2, '사진 인증', 'titlse', 1);
